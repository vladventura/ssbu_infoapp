...
class _MoveCardState extends State<MoveCard> {
      ...
      child: Container(
        ...
        child: new Row(
          children: [
            bottomBarButton(),
            Spacer(flex: 5),
            new Text(_currentName, style: TextStyle(color: Colors.white)),
            Spacer(flex: 1),
            bottomBarArrows(),
            Spacer(
              flex: 1,
  ...
  Widget bottomBarArrows() {
    return (widget.move.length == 1
        ? new Container()
